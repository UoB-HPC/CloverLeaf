...
void clover_exchange(global_variables &globals, const int fields[NUM_FIELDS], const int depth) {
  ...
  auto left_rcv_staging = stage ? static_cast<double *>(std::malloc(left_rcv_device.size * sizeof(double))) : nullptr;
  auto left_snd_staging = stage ? static_cast<double *>(std::malloc(left_snd_device.size * sizeof(double))) : nullptr;
  auto right_rcv_staging = stage ? static_cast<double *>(std::malloc(right_rcv_device.size * sizeof(double))) : nullptr;
  auto right_snd_staging = stage ? static_cast<double *>(std::malloc(right_snd_device.size * sizeof(double))) : nullptr;
  auto top_rcv_staging = stage ? static_cast<double *>(std::malloc(top_rcv_device.size * sizeof(double))) : nullptr;
  auto top_snd_staging = stage ? static_cast<double *>(std::malloc(top_snd_device.size * sizeof(double))) : nullptr;
  auto bottom_rcv_staging = stage ? static_cast<double *>(std::malloc(bottom_rcv_device.size * sizeof(double))) : nullptr;
  auto bottom_snd_staging = stage ? static_cast<double *>(std::malloc(bottom_snd_device.size * sizeof(double))) : nullptr;
