...
void update_tile_halo_r_kernel( //
    ...
    clover::Buffer2D<double> &mass_flux_y, int right_xmin, int right_xmax, int right_ymin, int right_ymax,
    clover::Buffer2D<double> &right_density0, clover::Buffer2D<double> &right_energy0, clover::Buffer2D<double> &right_pressure,
    clover::Buffer2D<double> &right_viscosity, clover::Buffer2D<double> &right_soundspeed, clover::Buffer2D<double> &right_density1,
    clover::Buffer2D<double> &right_energy1, clover::Buffer2D<double> &right_xvel0, clover::Buffer2D<double> &right_yvel0,
    clover::Buffer2D<double> &right_xvel1, clover::Buffer2D<double> &right_yvel1, clover::Buffer2D<double> &right_vol_flux_x,
    clover::Buffer2D<double> &right_vol_flux_y, clover::Buffer2D<double> &right_mass_flux_x, clover::Buffer2D<double> &right_mass_flux_y,
