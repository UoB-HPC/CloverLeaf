...
void clover_pack_message_left(global_variables &globals, int x_min, int x_max, int y_min, int y_max, clover::Buffer2D<double> &field,
  ...
  clover::par_ranged1(globals.context.queue, Range1d{y_min - depth + 1, y_max + y_inc + depth + 2}, [=](int k) {
...
void clover_unpack_message_top(global_variables &globals, int x_min, int x_max, int y_min, int y_max, clover::Buffer2D<double> &field,
...
void clover_pack_message_bottom(global_variables &globals, int x_min, int x_max, int y_min, int y_max, clover::Buffer2D<double> &field,
...
void clover_unpack_message_bottom(global_variables &globals, int x_min, int x_max, int y_min, int y_max, clover::Buffer2D<double> &field,
